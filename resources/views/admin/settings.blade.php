                    ...
                    <div class="d-lg-flex justify-content-lg-left">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            ...
                            <div class="tab-pane fade" id="paymentGatewaySettings">
                                ...
                                <hr>
                                <h2> <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/img/various/logo-payu.png" alt="PayU" style="width: 35px"> PayU</h2>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>PayU Key Id:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="payuKeyId"
                                            value="{{ config('settings.payuKeyId') }}"
                                            placeholder="PayU Key Id (Deje en blanco si no usa PayU)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>PayU Secret Key:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="payuKeySecret"
                                            value="{{ config('settings.payuKeySecret') }}"
                                            placeholder="PayU Secret Key (Deje en blanco si no usa PayU)">
                                    </div>
                                </div>
